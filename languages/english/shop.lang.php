...
// frontend
// Shop
$l['mint_service_items_shop'] = 'Shop';

$l['mint_page_economy_items_shop'] = 'Item Shop';
$l['mint_shop_item_categories'] = 'Item Categories';
$l['mint_shop_item_category'] = 'Item Shop: {1}';
$l['mint_shop_items_left'] = '{1} left';
$l['mint_shop_items_none_left'] = 'Sold Out';

$l['mint_page_economy_shop_item'] = 'Item Sale';
$l['mint_shop_item_not_found'] = 'Could not find specified item sale.';
$l['mint_shop_item_ask_price'] = 'Price';
$l['mint_shop_item_value_total'] = 'Total';
$l['mint_shop_item_in_stock'] = 'In Stock';
$l['mint_shop_item_action_purchase'] = 'Purchase';

$l['mint_page_economy_shop_item_purchase'] = 'Purchase Item';
$l['mint_shop_item_purchase_success'] = 'Successfully purchased {1} item(s).';
$l['mint_shop_item_purchase_error'] = 'Could not execute the purchase.';
...
$l['mint_admin_shop_items_sales_limit_description'] = 'Choose how many times total the item can be sold.';
